...
class BaseRequest(SetUp):
    """
    This class provides methods for making API requests and retrieving data.
    It inherits from the SetUp class to use the session and headers.

    Args:
        SetUp (object): Inheriting all the necessary setup configurations.

    Returns:
        dict: Returns a dictionary that will be deserialized in the menu and printed out for the user.
    """
